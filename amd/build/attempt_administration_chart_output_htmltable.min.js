 ...
 */
define("mod_adaptivequiz/attempt_administration_chart_output_htmltable",["jquery","core/chart_output_htmltable","mod_adaptivequiz/attempt_administration_chart_dataset_config"],(function($,OutputTable,DatasetConfig){function AttemptAdministrationChartOutputTable(){OutputTable.apply(this,arguments)}return AttemptAdministrationChartOutputTable.prototype=Object.create(OutputTable.prototype),AttemptAdministrationChartOutputTable.prototype._makeTable=function(){let tbl=OutputTable.prototype._makeTable.apply(this,arguments);const dataIndicesToRemove=[DatasetConfig.indices.STANDARD_ERROR_MAX,DatasetConfig.indices.STANDARD_ERROR_MIN],selectorsToRemove=dataIndicesToRemove.flatMap((dataIndexToRemove=>[`th:nth-child(${dataIndexToRemove+2})`,`td:nth-child(${dataIndexToRemove+2})`]));return tbl.find(selectorsToRemove.join()).remove(),tbl},AttemptAdministrationChartOutputTable}));
