...
final class sql_and_params {
    ...
    public static function default(int $adaptivequizid, context $context): self {
        list ($attemptsql, $params) = self::attempt_sql_and_params();

        $fields = 'u.id' . get_extra_user_fields_sql($context, 'u', '', ['id, email'])
    ...
    public static function for_enrolled_with_no_attempts(int $adaptivequizid, sql_join $enrolledjoin, context $context): self {
        $fields = 'DISTINCT u.id' . get_extra_user_fields_sql($context, 'u', '', ['id, email'])
            . ',' . get_all_user_name_fields(true, 'u')
    ...
    public static function for_enrolled_with_attempts(int $adaptivequizid, sql_join $enrolledjoin, context $context): self {
        list ($attemptsql, $params) = self::attempt_sql_and_params();
    ...
    public static function for_not_enrolled_with_attempts(int $adaptivequizid, sql_join $enrolledjoin, context $context): self {
        list ($attemptsql, $params) = self::attempt_sql_and_params();
