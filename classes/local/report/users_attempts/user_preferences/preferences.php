...
/**
 * A value object encapsulating user preferences for the report table's output.
 *
...
final class preferences {
    ...
    private function __construct(int $perpage, int $showinitialsbar) {
    ...
    public static function defaults(): self {
        return new self(self::PER_PAGE_DEFAULT, self::SHOW_INITIALS_BAR_DEFAULT);
    }
}
