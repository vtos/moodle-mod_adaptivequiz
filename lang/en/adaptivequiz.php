...
$string['indvuserreport'] = '{$a->quizname} - individual user attempts report for {$a->username}';
$string['activityreports'] = 'Attempts report';
$string['stopingconditionshdr'] = 'Stopping conditions';
$string['reviewattemptreport'] = '{$a->quizname} - reviewing attempt by {$a->fullname} submitted on {$a->finished}';
